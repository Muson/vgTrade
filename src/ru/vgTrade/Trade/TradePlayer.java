...
public class TradePlayer {
    ...
    public void tradeFinish(ItemStack[] rightContents, ItemStack[] leftContents) {
        player.sendMessage(ChatColor.GREEN + LanguageManager.getString(LanguageManager.Strings.FINISHED) + " " + ChatColor.RED + toItemList(leftContents) + ChatColor.WHITE + " |-| " + ChatColor.RED + toItemList(rightContents));
    }
